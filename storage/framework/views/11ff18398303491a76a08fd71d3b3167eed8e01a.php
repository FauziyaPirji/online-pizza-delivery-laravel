    ...
    <body>
            ...
            <div class="table-wrapper">
                <div class="table-title card bg-body-tertiary">
                    <div class="form-row d-flex">
                        ...
                        <div class="col">
                            <form action="<?php echo e(route('user.trash')); ?>" method="get">
                                <button class="btn btn-primary float-right btn-sm">Go to trash user</button>
                            </form>
                        </div>
                    </div>
                </div>
                <form action="<?php echo e(url('import-users')); ?>" method="POST" enctype="multipart/form-data" class="form-inline d-flex align-items-center mb-3">
                    <?php echo csrf_field(); ?>
                        ...
                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="<?php echo e(route('user.delete', ['id' => $user->id])); ?>" method="get">
        ...
        <div class="modal fade" id="newCustomer" tabindex="-1" role="dialog" aria-labelledby="newCustomer" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header" style="background-color: rgb(111 202 203);">
                        <h5 class="modal-title" id="newCustomer">Create New Customer</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body text-dark">
                        <form action="<?php echo e(route('admin_user_list')); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <b><label for="firstName">First Name:</label></b>
...
</html><?php /**PATH D:\College\Sem-4\Laravel project\pizza_website\resources\views/admin/admin_user_list.blade.php ENDPATH**/ ?>