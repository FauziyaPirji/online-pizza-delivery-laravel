            ...
            <div class="table-wrapper">
                <div class="table-title card bg-body-tertiary">
                    <div class="form-row d-flex">
                        <div class="col-sm-4">
                            <h2>User Trash <b>Details</b></h2>
                        </div>
                        <div class="col">
                            <form action="<?php echo e(route('admin_user_list')); ?>" method="get">
                                <button class="btn btn-primary float-right btn-sm">Back to all User</button>
                            </form>
                        </div>
                    </div>
                </div>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                <a href="<?php echo e(route('user.permanentDelete', ['id' => $user->id])); ?>"><button class="btn btn-sm btn-danger" style="margin-left:35px;margin-top:4px;">Delete</button></a>
                                <a href="<?php echo e(route('user.restore', ['id' => $user->id])); ?>"><button class="btn btn-sm btn-primary" style="margin-left:35px;margin-top:4px;">Restore</button></a>
...
<?php /**PATH C:\New\pizza_website\resources\views/admin/user-trash.blade.php ENDPATH**/ ?>