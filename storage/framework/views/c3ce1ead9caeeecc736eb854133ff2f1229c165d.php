...
<html lang="en">
    ...
    <body>  
        ...
        <div class="container-md card bg-body-tertiary text-light" style="background-image: url( 'assets/images/blur.jpg' );margin-top:-50px;">
            <center>
            <form class="needs-validation" action="<?php echo e(route('password.request')); ?>" method="post" novalidate>
                <?php echo csrf_field(); ?>
                <br>
...
</html><?php /**PATH D:\College\Sem-4\Laravel project\pizza_website\resources\views/forgot_password.blade.php ENDPATH**/ ?>