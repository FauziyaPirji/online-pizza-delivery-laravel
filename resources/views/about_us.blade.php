          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <div class="carousel-background">
                <img src="{{ asset('assets/images/slide-1.jpg') }}" class="d-block w-100" style="opacity:0.2;height:650px;">
              </div>
            ...
            <div class="carousel-item">
              <img src="{{ asset('assets/images/slide-2.jpg') }}" class="d-block w-100" style="opacity:0.2;height:650px;">
              <div class="carousel-caption d-flex flex-column h-100 align-item-center justify-content-center bottom-0">
                <h1>Our Mission</h1>
